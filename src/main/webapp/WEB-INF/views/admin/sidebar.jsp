	...
	<section class="sidebar">
		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
					<span>Product Mgmt</span> <span class="pull-right-container">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
					<span>Address Mgmt</span> <span class="pull-right-container">
						<i class="fa fa-angle-left pull-right"></i>
				</span>
			</a>
				<ul class="treeview-menu">
					<li class="active"><a href="adminAddAddress"><i
							class="fa fa-circle-o"></i>Address Line Mgmt</a></li>
					<li><a href="adminAddPincode"><i class="fa fa-circle-o"></i>
							Pincode Mgmt</a></li>
					<li><a href="adminAddCity"><i class="fa fa-circle-o"></i>
							City Mgmt</a></li>
					<li><a href="adminStates"><i class="fa fa-circle-o"></i>
							State Mgmt</a></li>
				</ul></li>
